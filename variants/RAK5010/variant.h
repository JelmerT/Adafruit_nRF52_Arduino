...
#define LED_ORANGE           PIN_LED2
#define LED_BLUE             PIN_LED1 // for bluefruit
...
#define PIN_QSPI_CS          42
#define PIN_QSPI_IO0         47
#define PIN_QSPI_IO1         46
#define PIN_QSPI_IO2         45
